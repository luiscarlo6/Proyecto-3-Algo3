...
public class Main {
	...
	/**
	 * @param args
	 *            Argumentos de entrada, <Archivo.in> <Archivo.out>
	 */
	...
	/**
	 * @param s
	 *            con un scanner de archivo, genera un grafo
	 * @return el grafo
	 */
	...
	/**
	 * @param grafo
	 *            donde se guardaran las carreteras
	 * @param s
	 *            Sanner del archivo
	 * @param m
	 *            numero de carreteras
	 */
	private static void guardarCarreteras(Graph grafo, Scanner s, int m) {
		if (s.hasNextLine()) {
			...
			while (i != m) {
				...
				if (!(peso >= 1 && peso <= 100)) {
					System.out
					.println("Error, el archivo no cumple el formato");
					System.exit(0);
				}
	...
	/**
	 * @param grafo
	 *            donde se guardaran las ciudades
	 * @param s
	 *            scanner de archivo
	 * @param n
	 *            numero de ciudades
